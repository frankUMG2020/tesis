...
@section('content_header')
    <h2>
      Ficha médica para niños
      <a href="{{ route('fichaMedicaN.create') }}" class="btn btn-info">Nuevo</a>       
    </h2>
      ...
      <div class="card">
        <div class="card-header py-4">
          ...
          <div class="card-tools">
            <form action="{{ route('fichaMedicaN.index') }}" method="get" role="search">
              {{ csrf_field() }}
                      ...
                      <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                          <li class="list-group-item">
                            <b>Parto</b> <a class="float-right">{{ $value->parto->nombre }}</a>
                          </li>
                          <li class="list-group-item">
                            <b>Alimentación</b> <a class="float-right">{{ $value->alimentacion->nombre }}</a>
                          </li>
                          <li class="list-group-item">
